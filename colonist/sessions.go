...
// SessionRepo is a parent directory that contains inidividual colony
// sessions.
...
// NewSessionRepo creates or opens a colony session repo.
func NewSessionRepo(colony *Colony, repoPath string, idGenFunc func() string) (*SessionRepo, error) {
...
func (s *Session) apply(boundExecutions []*boundExecution) (<-chan string, <-chan *Result, error) {
	logger.Trace.Println("colony session: running apply without graph")
	...
	logger.Trace.Printf("colony: %d executions to apply\n", numberOfExecutions)
...
func (s *Session) applyWithGraph(boundExecutions []*boundExecution) (<-chan string, <-chan *Result, error) {
	logger.Trace.Println("colony session: running apply with graph")
...
func (s *Session) plan(boundExecutions []*boundExecution, detach bool) (<-chan string, <-chan *Result, error) {
	logger.Trace.Println("colony session: running plan")
	...
	logger.Trace.Printf("colony: %d executions to plan\n", numberOfExecutions)
