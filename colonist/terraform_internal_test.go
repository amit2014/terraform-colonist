...
func TestColonyUsesDefaultTerraformVersion(t *testing.T) {
	t.Parallel()

	c, err := NewColonyFromConfigFile("fixtures/test-terraform-default-version/colony.yaml")
...
func TestColonyUsesDefaultTerraformPath(t *testing.T) {
	t.Parallel()

	c, err := NewColonyFromConfigFile("fixtures/test-terraform-default-path/colony.yaml")
	require.NoError(t, err)
...
func TestSharedPluginCache(t *testing.T) {
	...
	c, err := NewColonyFromConfigFile("fixtures/test-terraform-shared-plugin-cache/colony.yaml")
	require.NoError(t, err)
...
func TestSharedPluginCachePreservesExisting(t *testing.T) {
	...
	c, err := NewColonyFromConfigFile("fixtures/test-terraform-shared-plugin-cache-preserve-existing/colony.yaml")
	require.NoError(t, err)
