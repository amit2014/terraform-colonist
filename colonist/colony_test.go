...
func TestMissingDependencyExecution(t *testing.T) {
	...
	c, err := colonist.NewColonyFromConfigFile("fixtures/test-missing-dependency-execution/colony.yaml")
...
func TestMissingDependencyModule(t *testing.T) {
	...
	c, err := colonist.NewColonyFromConfigFile("fixtures/test-missing-dependency-module/colony.yaml")
