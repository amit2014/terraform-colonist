...
func NewConfigFromFile(configFilePath string) (*conf.Colony, error) {
...
// NewColonyFromConfigFile creates a new Colony based on the specified
// config file.
func NewColonyFromConfigFile(configFilePath string) (*Colony, error) {
	...
	return NewColony(*config)
}

// NewColonyFromYAML creates a new Colony based on the specified YAML
// config.
func NewColonyFromYAML(yamlBytes []byte) (*Colony, error) {
...
// configFromYAML takes YAML bytes and returns a Colony configuration
// struct.
func configFromYAML(yamlBytes []byte, rootPath string) (*conf.Colony, error) {
	var config conf.Colony
...
func setDefaults(config *conf.Colony, rootPath string) error {
	logger.Trace.Printf("config: setting defaults, rootPath: \"%v\"", rootPath)

	// For cases where we're creating a new colony that is not from a
...
func setTerraformVersionFields(config *conf.Colony) error {
...
func rewriteConfigPaths(rootPath string, config *conf.Colony) error {
