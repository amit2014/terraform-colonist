...
func TestHookStartupSuccess(t *testing.T) {
	...
	c, err := NewColonyFromConfigFile("fixtures/test-hook-startup-success/colony.yaml")
...
func TestHookStartupFail(t *testing.T) {
	...
	c, err := NewColonyFromConfigFile("fixtures/test-hook-startup-fail/colony.yaml")
	require.Nil(t, c)
...
func TestHookInjectEnvVars(t *testing.T) {
	...
	c, err := NewColonyFromConfigFile("fixtures/test-hook-inject-env-vars/colony.yaml")
	require.NoError(t, err)
	require.NotNil(t, c)
