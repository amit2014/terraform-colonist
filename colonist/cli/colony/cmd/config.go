...
import "github.com/uber/terraform-colonist/colonist/utils"

// configFileSearchPaths is the default list of paths the colony CLI
// will attempt to find a config file at.
var configFileSearchPaths = []string{
	"colony.yaml",
	"colony.yml",
	"terraform/colony.yaml",
	"terraform/colony.yml",
}
