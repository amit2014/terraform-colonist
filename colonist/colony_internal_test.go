...
// testReadResults reads all results channel from a colony operation and
...
func TestPlanSuccess(t *testing.T) {
	...
	c, err := NewColonyFromConfigFile("fixtures/test-plan-success/colony.yaml")
...
func TestApplyFailModule(t *testing.T) {
	...
	c, err := NewColonyFromConfigFile("fixtures/test-apply-fail-module/colony.yaml")
	require.NoError(t, err)
